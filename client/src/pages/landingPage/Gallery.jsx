    ...
    <>
        <div className="csGallery">
            ...
            <div className='flex flex-wrap justify-evenly lg:justify-between w-full lg:w-3/4 mx-auto'>
                <div className='imageCard' data-aos="slide-up" data-aos-delay="100" data-aos-anchor-placement="center-bottom">
                ...
                <div className='imageCard' data-aos="slide-up" data-aos-delay="200" data-aos-anchor-placement="center-bottom">
                ...
                <div className='imageCard' data-aos="slide-up" data-aos-delay="300" data-aos-anchor-placement="center-bottom">
